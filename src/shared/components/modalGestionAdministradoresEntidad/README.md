...
Este componente es un modal reutilizable para gestionar listas de administradores o miembros de cualquier entidad (organizaciones, equipos, jugadores, etc.). Permite agregar nuevos miembros por email y remover miembros existentes.
