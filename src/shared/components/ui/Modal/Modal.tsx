 ...
 * pantalla completa en mobile respetando el área segura y botón de cerrar de 44px. Esta app es
 * la que más overlays hechos a mano tiene (10), así que es donde más importa.
 */
